...
interface SoftwareInventoryRecordsProps {
  ...
  onDownload: (record: SoftwareInventoryRecord) => void;
}
...
export const SoftwareInventoryRecords = ({
  ...
  }, [records, search, status, department, sortKey, ascending]);
  ...
  return (
    <section className="panel">
      ...
      <p className="helper-text">Generated forms are ready for print or HTML download per record.</p>
            ...
            {filtered.map((record) => (
              <tr key={record.id}>
                ...
                <td className="row-actions">
                  ...
                  <button type="button" className="ghost" onClick={() => onDownload(record)}>
                    Download
                  </button>
                </td>
              </tr>
