  ...
  return (
    <section className="panel print-shell">
      ...
      <div className="print-form" ref={ref}>
        ...
        <table className="pf-table pf-sigs" style={{ marginTop: "10px" }}>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td className="pf-sig-cell" style={{ height: "54px", textAlign: "center" }}>
              ...
              <td className="pf-sig-cell" style={{ textAlign: "center" }}>
