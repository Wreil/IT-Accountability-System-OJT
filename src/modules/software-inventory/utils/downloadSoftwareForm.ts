    ...
    <section class="sheet">
      ...
      <table>
        <tbody>
          ...
          <tr><th>Subscription</th><td>${safe(record.subscription)}</td></tr>
          ...
          <tr><th>Renewal Date</th><td>${safe(record.renewalDate || record.expiryDate)}</td></tr>
          <tr><th>Expiration Date</th><td>${safe(record.expirationDate || record.expiryDate)}</td></tr>
